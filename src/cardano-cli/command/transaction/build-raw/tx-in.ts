...
class SpendingReferenceTxInExecutionUnits extends CommandParameter {
  constructor(private timeUnits: number, private spaceUnits: number) {
    super();
  }
  asParameter(): string {
    // --spending-reference-tx-in-execution-units (INT, INT)
    return `--spending-reference-tx-in-execution-units (${this.timeUnits}, ${this.spaceUnits})`;
  }
}
...
export class TxInSpending extends CommandParameter {
  ...
  private spendingReferenceTxInExecutionUnits?: SpendingReferenceTxInExecutionUnits;
  ...
  withSpendingReferenceTxInExecutionUnits(
    spendingReferenceTxInExecutionUnits: SpendingReferenceTxInExecutionUnits
  ): TxInSpending {
    this.spendingReferenceTxInExecutionUnits =
      spendingReferenceTxInExecutionUnits;
    return this;
  }
  ...
  asParameter(): string {
    ...
    if (this.spendingReferenceTxInExecutionUnits) {
      outputParams.push(this.spendingReferenceTxInExecutionUnits.asParameter());
    }
