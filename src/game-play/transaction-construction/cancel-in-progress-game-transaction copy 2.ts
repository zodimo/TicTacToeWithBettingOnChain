...
import { CancelInProgressGameCommand, GameStateFactory } from "../../app/game-data.js";
...
export const sendCancelInProgressGameCommandToScriptTransaction: (
  playerWallet: Wallet,
  ...
  console.log("#########################################");
  console.log("######## CANCEL IN PROGRESS GAME ########");
  console.log("#########################################");
  ...
  const command = new CancelInProgressGameCommand(gameStateFromScriptData);
